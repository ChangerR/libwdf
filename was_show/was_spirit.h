...
public:
    static WasSpirit* createSpirit(unsigned char* data,size_t len) {
    ...
    unsigned short get_spirit_count() const {
        return _wasHead.spiritcount;
    }

    unsigned short get_frame_count() const {
        return _wasHead.framecount;
    }

    Frame* get_frame(int s,int f) {
        return &_frames[s][f];
    }

    unsigned short get_width() const {
        return _wasHead.width;
    }

    unsigned short get_height() const {
        return _wasHead.height;
    }
